...
public enum ErrorCode {
  ...
  CHAT_MESSAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "CHAT_MESSAGE_NOT_FOUND", "채팅방을 찾을 수 없습니다."),
  CHAT_SEARCH_NO_NEXT_HIT(HttpStatus.NOT_FOUND, "CHAT_SEARCH_NO_NEXT_HIT", "다음 검색 결과가 없습니다."),
